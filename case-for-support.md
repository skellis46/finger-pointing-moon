...
Practice-research is the de-facto means by which artist-scholars make claims for new knowledge in the Academy. However, "no epistemology of artistic research has yet been produced."[@schiesser-2015-what p.201] _Finger Pointing Moon_ examines the fundamental problem of what is known or understood differently as a consequence of employing practice-research methods. The project tackles this problem via three research questions:
...
Scrivener wrote that the "art object does not embody a form of knowledge."[@scrivener_art_2002 n.pag.] Yet Borgdorff suggests that knowledge is "embodied in art practices."[@borgdorff_debate_2006 p.13] Even in disagreement, both scholars focus on the limits of the artefact in practice-research and draw the art object's audience into the issue -- Borgdorff through his focus on hermeneutics, and Scrivener through his argument that artefacts require interpretation.[@scrivener_art_2002]  
...
- **Experimental documentation** developed through critical reflection with writing and still and moving images
- **Empirical and sensorial observation** through first and third-person observation of the practice
...
- **Critical analysis** of these materials to develop deep understanding of the use of epistemic proxies in practice-research
- **Scholarly writing** to understand and communicate findings

3. _Hyper-specificity:_ 

- **Systematic review and meta-analysis** of practice-research field to understand languages used to express approaches, findings and failures
- **Critical analysis** of these languages to design, propose and share a lexicon of epistemic findings and failures in practice-research
...
Please see the Workplan attachment (Ellis_SK_Workplan.docx) for a complete breakdown of research and development activities undertaken in each month of the project. 
