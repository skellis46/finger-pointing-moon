...
_Finger Pointing Moon_ is designed to re-shape the epistemics of practice-research through empirical observations of body-based movement practices. In doing so, it seeks to value practice-research "within the context of the research system as a whole and [to improve] the codification and dissemination of practice-research"{2} The PI's unique experience and leadership in dance practice-research over three decades, both in and beyond the academy, equip him particularly well to realise the project's ambitions.
...
The project team comprises Simon Ellis (PI, dance artist-scholar), an RA, and an Advisory Group, with expert input from Dr. Joanne "Bob" Whalley and Prof. Roger Kneebone. There are three collaborating project partners: Dancehouse (Australia), S'ALA (Italy) and Siobhan Davies Studio (UK).
...
_1. Unforgettable_ [O3] will be an exhibition of materials from a practice of gathering experiences of dance and movement. Artists, scholars and audiences from around the world will be contacted through local and international organisations to send writing that describes a single unforgettable experience in dance. The process will encourage artists and audiences to use personal links and networks to share the idea. The written documents will be curated into an exhibition by working with artists and audiences associated with project partner _Siobhan Davies Studio_ (UK). _Unforgettable_ builds on the research's epistemic narrative by foregrounding the role of memory in knowledge generation. The process and exhibition are designed to: i) inspire creativity in how other researchers understand and represent the scope of their largely theoretical undertakings; ii) seek wider impact by ambitiously engaging a broad cross-section of participants; iii) develop a new and formal research-informed partnership and collaboration with a non-academic organisation in the UK, and informal collaborations with people who submit materials from around the world.
...
Many of the outputs include community building and public engagement features [O3,O4,O8,O9,O10]. These communities will be brought together online and closely with project partners to develop methods to create conversations about the project outputs and how people are impacted by the research. The ongoing engagement with users and beneficiaries in these outputs will provide wide scope for evaluating the research and assessing the type, quality and importance of research impacts. These evaluations will include basic statistical data (numbers, demographics) and recorded conversations and written reflections. More ephemeral engagements, e.g. with audience members, will be evaluated through follow-up interviews. The goal is to gather rich impact data that reflect the experiences of the users and beneficiaries.
