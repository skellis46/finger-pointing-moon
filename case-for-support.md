# Finger pointing moon: understanding change through practice-research
...
_Finger Pointing Moon_ is designed to re-shape the epistemic function of practice-research by drawing artistic practices and allied methods into contact with empirical observations of body-based movement practices. In doing so, it seeks to value practice research "within the context of the research system as a whole and [to improve] the codification and dissemination of practice research"{2} The PI's unique experience and leadership in practice-research over three decades, both in and beyond the academy, make him ideal to realise the project's ambitions.

The research aims to deepen understanding of the epistemic limits of the body, while seeking to delimit the epistemics of practice-research. Without limits the status quo is preserved in which an enclave of artists in the academy produces unconnected cells of knowledge that are difficult to substantiate. Instead, limits afford epistemic bridges with other communities of research. _Finger Pointing Moon_ will pave the way for practice-research to climb out of solipsism and into dialogue with knowledge claims of other arts and humanities disciplines. This dialogue will add weight to the pressing need for practice-research's "full acceptance in the corridors of power and policy making."{3} The diverse outputs proposed in the research and development components of the fellowship build on the PI's standing in the academic and professional communities. The project and its outputs also reflect the value of epistemic concerns and "epistemic well-being"{4} to the wider public, and respond to the AHRC's vision for the future to support research that studies "what it is to be human".{5}

The project team comprises the PI, an RA, and an Advisory Group, with expert input from Dr. Joanne "Bob" Whalley and Prof. Roger Kneebone. There are three collaborating project partners: Dancehouse (Australia), S'ALA (Italy) and Siobhan Davies Studio (UK).
...
_Finger Pointing Moon_ adopts empirical practice-research fieldwork as a starting point to test practice-research's epistemic possibilities, limitations and failings. The RQs are designed to examine the problem of knowledge in practice-research by exploring how: i) variations of process are circulated and fetishized;{6} ii) representational proxies are assumed to stand in for "epistemic things";{7} iii) outcomes are rarely explicitly made in dialogue with other overlapping practices;{8} and iv) there are few if any limits to the epistemic claims made on behalf of practice-research.{9}
...
The cross-disciplinary Advisory Group -- Efrosini Protopapa, Danielle Moncrieffe, Harris Beider, Charlotte Waelde and Lee Miller -- will meet remotely with the PI every six-months to provide high-level guidance. CovUni will allocate administrative support to the PI for purchasing, finances and technical support when required.
