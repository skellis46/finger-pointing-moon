...
## 20210514 - draft to Annie and Kat at Siobhan Davies Dance

Dear Annie and Kat

First of all, congratulations. What a remarkable thing you are doing. I can also imagine that your lives are quite full at the moment. So here I am adding to that -- not sure that's the smartest move on my part!

I'd like to pitch a project to you for SDD to be involved as a partner. It's a large Arts and Humanities Research Council bid I've been developing for some time centred on 'knowledge and the body'. The part that I thought might interest you is called Unforgettable and it would involve developing some mutually beneficial public engagement activities (workshops, conversations, etc) based on turning SDD into an exhibition space or house of "remembered dancing". It will involve my gathering a large collection of letters or messages that each describe a single unforgettable moment or experience of dance or dancing, then curating and presenting these in the space (perhaps as part of a community practice). Here are two examples from what I've gathered so far responding to this prompt:

>Describe your feelings from a single 'unforgettable' moment of dancing or watching dance.
...
I'm planning to submit the bid in September this year. The project if funded would then start in September 2022, and SDD's involvement wouldn't be until September 2023. Quite a way off. 

If there's something in here for your future thinking for SDD I'd love to meet briefly in the next 2-3 weeks. I'm generally free Monday, Wednesday or Friday afternoons. 

Sending very best wishes, and thanks.
...
## 20210514 - Ina Grebliunaite-Reddy (Research Development Officer; email ac8438@coventry.ac.uk).

Dear Ina
I trust you are well.
My name is Simon Ellis and I'm a researcher in the Centre for Dance Research. I'm getting towards the pointy end of a very long process of developing an AHRC Research, Development and Engagement bid. 
My expectation is that it will be ready to submit before the end of July, but certainly August/September. 
I wonder how best it is to keep you updated with the bid, and what systems you have in place to support and work with bids. 
I'm looking forward to working with you.
Thanks, and sending very best wishes.
Simon
...
I want to invite you to contribute to an art project called _unforgettable_. The project is an exhibition made up of a collection of messages that each describe a single unforgettable moment or experience of dance or dancing. My hope is that the project will become a growing catalogue of a global community's experiences of dance.
